...
- [x] Koble `overwrite` / `rename` policy til preview-resultat (`prechecked=true` der mulig)
...
- [x] Ikke gjør hele operasjonen til feil hvis write lykkes men refresh feiler
