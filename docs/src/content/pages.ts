    ...
    sections: [
      {
        ...
        bullets: [
          ...
          'Thumbnail pipeline now supports OpenEXR (.exr) images',
          'HDR/EXR image thumbnail decode timeout window increased to reduce false timeout failures',
          'Archive extraction now enforces a high entry cap (2,000,000) in addition to the existing total-size cap (100 GB)',
