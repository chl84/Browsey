...
| `CO-EXT-005` | Gap | none | Batch extraction partial-completion/cancel summary behavior is not directly covered. |
...
2. Add multi-archive batch regression for mixed success/failure and cancellation
   summary behavior.
