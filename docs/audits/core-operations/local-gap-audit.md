...
1. Expand multi-item local copy/move hostile-condition coverage beyond the added later-source-failure, mid-batch-cancel, recursive merge-cancel, and recursive merge-failure rollback paths, especially per-item partial-summary assertions.
