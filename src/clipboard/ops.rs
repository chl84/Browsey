...
use super::{ClipboardMode, CopyProgressPayload};
...
pub(super) fn metadata_if_exists_nofollow(path: &Path) -> Result<Option<fs::Metadata>, String> {
...
pub(super) fn is_destination_exists_error(err: &str) -> bool {
